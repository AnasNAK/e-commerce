...
if ( ! function_exists( 'woodmart_vc_map_woodmart_table' ) ) {
	function woodmart_vc_map_woodmart_table() {
		if ( ! shortcode_exists( 'woodmart_table' ) || ! shortcode_exists( 'woodmart_table_row' ) ) {
			return;
		}
	...
	add_action( 'vc_before_init', 'woodmart_vc_map_woodmart_table' );
}
